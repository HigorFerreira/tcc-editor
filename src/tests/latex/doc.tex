...
%     {\bfseries\fontsize{10pt}{12pt}\selectfont\MakeUppercase}  % Bold, 10pt font size, uppercase
%     {\filright\MakeUppercase{\chaptertitlename} \thechapter}   % Right-aligned, uppercase chapter title
%     {4ex}                                                     % Space between the number and title
%     {}                                                        % Additional formatting before the title (empty placeholder)
%     []                                                        % Additional formatting after the title (empty placeholder)
...
% Add a list of listings at the beginning
\lstlistoflistings
\newpage

% Define the caption format for listings
