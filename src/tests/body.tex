...
\begin{47a0cc5c64a14d6eaab87605a174db21}
yarn dev
\end{47a0cc5c64a14d6eaab87605a174db21}
...
\begin{Code959aac2376b84c7cb1f3b61b56b87975}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code959aac2376b84c7cb1f3b61b56b87975}
...
\begin{Code4d7dd00bf66d478db846da9059bcd2a2}
...
\end{Code4d7dd00bf66d478db846da9059bcd2a2}
...
\begin{Codef4523d24999348dba2107afaaec973d7}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Codef4523d24999348dba2107afaaec973d7}
...
\begin{Codec1d5d30755734cdf86de58bc5507a5f6}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Codec1d5d30755734cdf86de58bc5507a5f6}
...
\begin{Code895e6488b5fe496d940957ed460959e4}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code895e6488b5fe496d940957ed460959e4}
...
\begin{Code64d011e4945e4447a2c14abe9a990f14}
[...]
...
[...]
\end{Code64d011e4945e4447a2c14abe9a990f14}
...
\begin{Codef0bee82c12024a7d805839fd06fa61ce}
[...]
...
[...]
\end{Codef0bee82c12024a7d805839fd06fa61ce}
...
\begin{Codebf3b68caacfa436c968a297ddd9aadbf}
[...]
...
\end{Codebf3b68caacfa436c968a297ddd9aadbf}
...
\begin{Code144e3990b28b48ccb43ec50a3a1b33c5}
[...]
...
[...]
\end{Code144e3990b28b48ccb43ec50a3a1b33c5}
...
\begin{Codef377219fd19446ba88f0725a1a9bbeee}
[...]
public render(){
...
[...]
\end{Codef377219fd19446ba88f0725a1a9bbeee}
...
\begin{Code07850c7729344019a17f165e1759a1e8}
[...]
...
[...]
\end{Code07850c7729344019a17f165e1759a1e8}
...
\begin{Codeea2f946e54a4499f9fd758777fddbbfb}
[...]
...
[...]
\end{Codeea2f946e54a4499f9fd758777fddbbfb}
...
\begin{Codec2462341fd4b473583e154e193b3d292}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Codec2462341fd4b473583e154e193b3d292}
...
\begin{Code4b8c521aca044caab392145f97fad0bc}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code4b8c521aca044caab392145f97fad0bc}
...
\begin{Code874154a5e63d49f486c71ba48b8a1ddb}
[...]
    let str = `${header}\n\n${acronyms}\n${abbreviations}\n${symbols}\n\n`;
...
\end{Code874154a5e63d49f486c71ba48b8a1ddb}
...
\begin{Codecb11e115c8f14fa38f6ce2200ad4d3b2}
...
\end{Codecb11e115c8f14fa38f6ce2200ad4d3b2}
