...
\begin{be1abcf2b41d4f41b98b2e0ea5a5a851}
yarn dev
\end{be1abcf2b41d4f41b98b2e0ea5a5a851}
...
\begin{Code25aab1d50657421292d15d823a4647b7}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code25aab1d50657421292d15d823a4647b7}
...
\begin{Code87fe3666f80041d1ac37e43621a74ebd}
...
\end{Code87fe3666f80041d1ac37e43621a74ebd}
...
\begin{Codee517a42c3d45497c9d0c6e18bcff57d6}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Codee517a42c3d45497c9d0c6e18bcff57d6}
...
\begin{Codea278b8472c8d491b8fea90801a0e5014}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Codea278b8472c8d491b8fea90801a0e5014}
...
\begin{Code06795a05a2574b76affb0236f69f6a35}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code06795a05a2574b76affb0236f69f6a35}
...
\begin{Codec1faee3c56a24514a96b5eebac8175d1}
[...]
...
[...]
\end{Codec1faee3c56a24514a96b5eebac8175d1}
...
\begin{Codeb98075c8bc8d4118afaa23e1d309017d}
[...]
...
[...]
\end{Codeb98075c8bc8d4118afaa23e1d309017d}
...
\begin{Codeb2e7905a259b4eb0ba3cd5ffa4b56b85}
[...]
...
\end{Codeb2e7905a259b4eb0ba3cd5ffa4b56b85}
...
\begin{Codef59fe1eafba949f5b85aa20112f03531}
[...]
...
[...]
\end{Codef59fe1eafba949f5b85aa20112f03531}
...
\begin{Code7fe6c2f3853043e0b1f768c8ddcaefab}
[...]
public render(){
...
[...]
\end{Code7fe6c2f3853043e0b1f768c8ddcaefab}
...
\begin{Code8a542fd939024c21849470bff9d4872b}
[...]
...
[...]
\end{Code8a542fd939024c21849470bff9d4872b}
...
\begin{Codeaf540b2fb546417db1853280deedeb0d}
[...]
...
[...]
\end{Codeaf540b2fb546417db1853280deedeb0d}
...
\begin{Codef8e32531f3e04e0a9af4f7b5c48f066e}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Codef8e32531f3e04e0a9af4f7b5c48f066e}
...
\begin{Codef73d5c413d46481f8cc4664e9e54a7ce}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Codef73d5c413d46481f8cc4664e9e54a7ce}
...
\begin{Code442e9ff4e74e4a87a43ffb26ff509ea5}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Code442e9ff4e74e4a87a43ffb26ff509ea5}
...
\begin{Code98024e9c54ae4f77a0ddeed01af0f90f}
...
\end{Code98024e9c54ae4f77a0ddeed01af0f90f}
