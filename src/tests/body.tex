...
\begin{12c653c887eb4b4db032ff2c696ea3db}
yarn dev
\end{12c653c887eb4b4db032ff2c696ea3db}
...
\begin{Codee0b90dc85426405886a50b811991c3e6}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Codee0b90dc85426405886a50b811991c3e6}
...
\begin{Code4afe45285174405ea099381d5b964cd0}
...
\end{Code4afe45285174405ea099381d5b964cd0}
...
\begin{Codeebd6ccd9992a43a6882e7a4aadcd7285}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Codeebd6ccd9992a43a6882e7a4aadcd7285}
...
\begin{Code5743063d83794448ba9025fdc5194f7b}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Code5743063d83794448ba9025fdc5194f7b}
...
\begin{Codec9fd16a241ae4be6b4c43a3d4ab5f914}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Codec9fd16a241ae4be6b4c43a3d4ab5f914}
...
\begin{Code470f390fc04e49548cc17ad0f650d7bb}
[...]
...
[...]
\end{Code470f390fc04e49548cc17ad0f650d7bb}
...
\begin{Code637fa2c00d54432d97b289cad470eb46}
[...]
...
[...]
\end{Code637fa2c00d54432d97b289cad470eb46}
...
\begin{Code3509542fa8f84e3a9aa6218d4b5220ee}
[...]
...
\end{Code3509542fa8f84e3a9aa6218d4b5220ee}
...
\begin{Code5a5e444bc6b8423b89edb3e2f4a9b2ba}
[...]
...
[...]
\end{Code5a5e444bc6b8423b89edb3e2f4a9b2ba}
...
\begin{Code51805e04b0f047498481d2df41382c74}
[...]
public render(){
...
[...]
\end{Code51805e04b0f047498481d2df41382c74}
...
\begin{Code21d5f6be818341148e270cea9e2454a7}
[...]
...
[...]
\end{Code21d5f6be818341148e270cea9e2454a7}
...
\begin{Code0426182afc9e466698bbf49dfffff86c}
[...]
...
[...]
\end{Code0426182afc9e466698bbf49dfffff86c}
...
\begin{Codef74fa9f2e1c64575ace2a78ad89ff27f}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Codef74fa9f2e1c64575ace2a78ad89ff27f}
...
\begin{Code88d8d7c1125e402fa5f59bf2a8ef4e9b}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code88d8d7c1125e402fa5f59bf2a8ef4e9b}
...
\begin{Codefb6a0bd89c8c4a1d96665e20bf75a385}
[...]
    let str = `${header}\n\n${acronyms}\n${abbreviations}\n${symbols}\n\n`;
...
\end{Codefb6a0bd89c8c4a1d96665e20bf75a385}
...
\begin{Codeef5d005e6b6a40bcb027d38c11f7407b}
...
\end{Codeef5d005e6b6a40bcb027d38c11f7407b}
