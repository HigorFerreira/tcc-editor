...
\begin{8c4fc4a6e8d043e4a1e06f4dc039e22f}
yarn dev
\end{8c4fc4a6e8d043e4a1e06f4dc039e22f}
...
\begin{Code64980b4558374bdc9c89d0dcd2f7f66a}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code64980b4558374bdc9c89d0dcd2f7f66a}
...
\begin{Code3e754f3010104a7881e68cea3031dd4d}
...
\end{Code3e754f3010104a7881e68cea3031dd4d}
...
\begin{Codeea6396637dd0483383a62d07a053148a}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Codeea6396637dd0483383a62d07a053148a}
...
\begin{Codee3772e0d3db845478b6415c75bbb9b8b}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Codee3772e0d3db845478b6415c75bbb9b8b}
...
\begin{Code4c949c9edf4c49d7aa07bf5b6a0bd4c5}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code4c949c9edf4c49d7aa07bf5b6a0bd4c5}
...
\begin{Code9e12d6570def47cb9cac0413ab6715d0}
[...]
...
[...]
\end{Code9e12d6570def47cb9cac0413ab6715d0}
...
\begin{Code5b47cb4d4b3e48cd9c056528790ab543}
[...]
...
[...]
\end{Code5b47cb4d4b3e48cd9c056528790ab543}
...
\begin{Codecb4da094444f4a4986893ff716b63774}
[...]
...
\end{Codecb4da094444f4a4986893ff716b63774}
...
\begin{Code12356ea09c3a40f6ac00a5e86cfd18a8}
[...]
...
[...]
\end{Code12356ea09c3a40f6ac00a5e86cfd18a8}
...
\begin{Codedbcf952b34294713b4680bc31c8cf24f}
[...]
public render(){
...
[...]
\end{Codedbcf952b34294713b4680bc31c8cf24f}
...
\begin{Code364317162d1f4346825a77caa534920d}
[...]
...
[...]
\end{Code364317162d1f4346825a77caa534920d}
...
\begin{Code5db2b8f388e84d76a1917a88ea6da482}
[...]
...
[...]
\end{Code5db2b8f388e84d76a1917a88ea6da482}
...
\begin{Codec9ba99dfbe7048be94361fd135c8be14}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Codec9ba99dfbe7048be94361fd135c8be14}
...
\begin{Code65ad01629ca049008ce5b13115c28042}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code65ad01629ca049008ce5b13115c28042}
...
\begin{Code40d45df77f884f2eb17f4c0edf407d3e}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Code40d45df77f884f2eb17f4c0edf407d3e}
...
\begin{Code209b4263d1ca46d3b4861242a0906331}
...
\end{Code209b4263d1ca46d3b4861242a0906331}
...
\begin{Code73d569fd338e4c35b85975e6cfc81b20}
yarn tex-make
\end{Code73d569fd338e4c35b85975e6cfc81b20}
