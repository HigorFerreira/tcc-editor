...
\begin{5f9422f8f10b49ca92a90ac505d8dbd2}
yarn dev
\end{5f9422f8f10b49ca92a90ac505d8dbd2}
...
\begin{Code3bf6e8092d5d43cf908d6217154e1cbe}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code3bf6e8092d5d43cf908d6217154e1cbe}
...
\begin{Codea6e986c21cb04e17a0b584a4b83f0255}
...
\end{Codea6e986c21cb04e17a0b584a4b83f0255}
...
\begin{Code65951ff4191f43b5a147cbd2d29d0997}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Code65951ff4191f43b5a147cbd2d29d0997}
...
\begin{Coded77e6ad668474c82be18e2f3d51a7705}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Coded77e6ad668474c82be18e2f3d51a7705}
...
\begin{Code576b60c745934ed8991a228e4f7c7891}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code576b60c745934ed8991a228e4f7c7891}
...
\begin{Code6815116651b24444a11d0596ad342c51}
[...]
...
[...]
\end{Code6815116651b24444a11d0596ad342c51}
...
\begin{Code55686b25a2b44b728eb3c0190bd78e4e}
[...]
...
[...]
\end{Code55686b25a2b44b728eb3c0190bd78e4e}
...
\begin{Code4f8a1cb5accd4fccb936cc5db4dc36fc}
[...]
...
\end{Code4f8a1cb5accd4fccb936cc5db4dc36fc}
...
\begin{Codeb1f05e50235e4907b05b96b12c2ea861}
[...]
...
[...]
\end{Codeb1f05e50235e4907b05b96b12c2ea861}
...
\begin{Codedb32e4b19e8445d5a93830fc1a3e4566}
[...]
public render(){
...
[...]
\end{Codedb32e4b19e8445d5a93830fc1a3e4566}
...
\begin{Code3ebe71a2cd68490eba49433770b1fd72}
[...]
...
[...]
\end{Code3ebe71a2cd68490eba49433770b1fd72}
...
\begin{Code5359def56d0b416692f1d2310024ecd2}
[...]
...
[...]
\end{Code5359def56d0b416692f1d2310024ecd2}
...
\begin{Code9de9e761a7f64a079b8b7e219f13ac8f}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Code9de9e761a7f64a079b8b7e219f13ac8f}
...
\begin{Code0264bd9370f04cc2a092f539cb2d7205}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code0264bd9370f04cc2a092f539cb2d7205}
...
\begin{Codec07f9c01965a46e093d4b5a3e8f9d306}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Codec07f9c01965a46e093d4b5a3e8f9d306}
...
\begin{Code6fa234f7ce9a48158b541af61dea511b}
...
\end{Code6fa234f7ce9a48158b541af61dea511b}
