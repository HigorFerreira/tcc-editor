...
\begin{8d1d527a4c16402ea86738c60b27118b}
yarn dev
\end{8d1d527a4c16402ea86738c60b27118b}
...
\begin{Code24355911b8f048deb249aceaa039244d}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code24355911b8f048deb249aceaa039244d}
...
\begin{Code0e8c269c2a624e6aa2dd006890f71c24}
...
\end{Code0e8c269c2a624e6aa2dd006890f71c24}
...
\begin{Code0118eb22c6b8424ab7b7933a00291b99}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Code0118eb22c6b8424ab7b7933a00291b99}
...
\begin{Code2cf6f64e2beb44d9932bec4aa1467d18}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Code2cf6f64e2beb44d9932bec4aa1467d18}
...
\begin{Code2f7555bbd03244de899c6248eaa401b0}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code2f7555bbd03244de899c6248eaa401b0}
...
\begin{Codea2aa373b6f364fc68443fc29f242f8ac}
[...]
...
[...]
\end{Codea2aa373b6f364fc68443fc29f242f8ac}
...
\begin{Codee0b833419a6644e284baa7ec8f8f0e3a}
[...]
...
[...]
\end{Codee0b833419a6644e284baa7ec8f8f0e3a}
...
\begin{Code95a5182535e043c0a57700bcb3519248}
[...]
...
\end{Code95a5182535e043c0a57700bcb3519248}
...
\begin{Code336b51387259490ea351aab88386836f}
[...]
...
[...]
\end{Code336b51387259490ea351aab88386836f}
...
\begin{Code2e72b56f8a7a4de3873e70ffeab7e4c7}
[...]
public render(){
...
[...]
\end{Code2e72b56f8a7a4de3873e70ffeab7e4c7}
...
\begin{Code481e74c0832c4ea5a959097b6a7d5b6a}
[...]
...
[...]
\end{Code481e74c0832c4ea5a959097b6a7d5b6a}
...
\begin{Code1ad4c6daddd845c0bfd4c9e2f3151cdc}
[...]
...
[...]
\end{Code1ad4c6daddd845c0bfd4c9e2f3151cdc}
...
\begin{Code4c8b2488807644e99e1b8a1b6f7adb9b}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Code4c8b2488807644e99e1b8a1b6f7adb9b}
...
\begin{Code6df017eb97364956a52b1b6c4a75b77b}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code6df017eb97364956a52b1b6c4a75b77b}
...
\begin{Code968de5b347094da9a1d530bcb60344aa}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Code968de5b347094da9a1d530bcb60344aa}
...
\begin{Coded8ef93fd69af4263988d31d444543504}
...
\end{Coded8ef93fd69af4263988d31d444543504}
...
\begin{Code745a03e35dc943c285dfbd35ebdd1f56}
yarn tex-make
\end{Code745a03e35dc943c285dfbd35ebdd1f56}
