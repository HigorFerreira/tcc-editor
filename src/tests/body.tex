...
\begin{69df10132de74c66b986f559b97112d8}
yarn dev
\end{69df10132de74c66b986f559b97112d8}
...
\begin{Code9c4569d72b13424ba3a6783238f51913}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code9c4569d72b13424ba3a6783238f51913}
...
\begin{Codeb77a5064b1e84280accdefdc52c4f02b}
...
\end{Codeb77a5064b1e84280accdefdc52c4f02b}
...
\begin{Code45f4816b06924b6c92d52902de4b9e9f}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Code45f4816b06924b6c92d52902de4b9e9f}
...
\begin{Code6c981e3ba1054fb5a9829b58edb489fc}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Code6c981e3ba1054fb5a9829b58edb489fc}
...
\begin{Codec1b6077c9f2a48038d58dc1efb63dbe1}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Codec1b6077c9f2a48038d58dc1efb63dbe1}
...
\begin{Codef150eb13695147d0903941b58536f0fd}
[...]
...
[...]
\end{Codef150eb13695147d0903941b58536f0fd}
...
\begin{Codef2fcaf0a60cd4693876fd4a5191a73ec}
[...]
...
[...]
\end{Codef2fcaf0a60cd4693876fd4a5191a73ec}
...
\begin{Codef4adc60e213c4f68bc964018e8706ca4}
[...]
...
\end{Codef4adc60e213c4f68bc964018e8706ca4}
...
\begin{Codeea6b3a4b3d3d4271a6e84acc1db10281}
[...]
...
[...]
\end{Codeea6b3a4b3d3d4271a6e84acc1db10281}
...
\begin{Code8b0245f282974584b0ef64732fff9ed3}
[...]
public render(){
...
[...]
\end{Code8b0245f282974584b0ef64732fff9ed3}
...
\begin{Code0f6bba6cb35546bfbcfe9f1beb5834f9}
[...]
...
[...]
\end{Code0f6bba6cb35546bfbcfe9f1beb5834f9}
...
\begin{Code080b67a151684b628d8301fc3b7dc0a5}
[...]
...
[...]
\end{Code080b67a151684b628d8301fc3b7dc0a5}
...
\begin{Code78eec6a7b76247b18989d8d19a89a57a}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Code78eec6a7b76247b18989d8d19a89a57a}
...
\begin{Code76496693f4634c1aa6e5117db172df9a}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Code76496693f4634c1aa6e5117db172df9a}
...
\begin{Code9e19fbadb1b94ff6a31b8d4a0bd67cd5}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Code9e19fbadb1b94ff6a31b8d4a0bd67cd5}
...
\begin{Code1f4bfedf3655469e958e23555113fdd3}
...
\end{Code1f4bfedf3655469e958e23555113fdd3}
