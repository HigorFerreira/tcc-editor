...
apenas envolvem o domínio do conteúdo específico, mas também a adesão às normas
...
outros). Ademais, ainda com respeito aos trabalhos acadêmicos, não somente a
regulamentação da 
\acrshort{nbr}
...
O \textit{TypeScript} possui um compilador, que nada mais é do que um
...
O processo de \textit{Parsing} é uma das partes mais vitais deste projeto.
...
O servidor da aplicação será construído em cima do \textit{NextJs}, a
...
Para criar uma rota para uma nova página no \textit{NextJs}, basta que
...
\begin{dfd9167e68fd486586f7fa21c4a67889}
yarn dev
\end{dfd9167e68fd486586f7fa21c4a67889}
...
\begin{Code2c9e7d9a509a472ab605c60c20432b84}
yarn run v1.22.19
$ next dev
    Next.js 14.1.1
    ...
    Ready in 2.7s
\end{Code2c9e7d9a509a472ab605c60c20432b84}
...
Tem-se uma estrutura básica com a \textit{tag} html, (a \textit{tag} raiz do documento),
...
\begin{Codec497bcddd3784ae1a571a07cb2321fa0}
...
\end{Codec497bcddd3784ae1a571a07cb2321fa0}
...
\begin{Code767d54a443ee42099a12ffebeb7080e9}
[...]
return (
    <main>
        <Container>
            ...
            <Editor
[...]
\end{Code767d54a443ee42099a12ffebeb7080e9}
...
\begin{Codec2804faf5d544873a3fa906d0644d313}
[...]
onReady={ ({ editor }) => {
    setLoading(false);
    setEditor(editor);
...
[...]
\end{Codec2804faf5d544873a3fa906d0644d313}
...
\begin{Code1df191ea3aed410a8b24f0db2b06c051}
[...]
useEffect(() => {
    if(storageError){
...
[...]
\end{Code1df191ea3aed410a8b24f0db2b06c051}
...
\begin{Code2a480f9bdc2f4e28aee7009a16504075}
[...]
...
[...]
\end{Code2a480f9bdc2f4e28aee7009a16504075}
...
\begin{Code36307dd7a4eb4bfdaf5cbdb8fb3c1485}
[...]
...
[...]
\end{Code36307dd7a4eb4bfdaf5cbdb8fb3c1485}
...
\begin{Code00e304024aed40f7b142fa9af03154ea}
[...]
...
\end{Code00e304024aed40f7b142fa9af03154ea}
...
\begin{Code8be7f7e8345241f7af3e5eea6047f79e}
[...]
...
[...]
\end{Code8be7f7e8345241f7af3e5eea6047f79e}
...
\begin{Code5899643560ad434e8ee83fd27bfe59e6}
[...]
public render(){
...
[...]
\end{Code5899643560ad434e8ee83fd27bfe59e6}
...
\begin{Codedff45ae52eaa4fce9dd59112136adb37}
[...]
...
[...]
\end{Codedff45ae52eaa4fce9dd59112136adb37}
...
\begin{Code8ffabcab6787404686144d36d435d856}
[...]
...
[...]
\end{Code8ffabcab6787404686144d36d435d856}
...
\begin{Code28c67caec09b4cea858567ccc4a86ee4}
[...]
    getName(): string {
        return 'header';
    }
...
\end{Code28c67caec09b4cea858567ccc4a86ee4}
...
Por fim, a lista é composta de uma iteração sobre as \textit{strings} do array presente
na propriedade list. Este array, após ajustado com a função map, é transformado
em uma \textit{string} unindo seus itens por uma quebra de linha com o auxílio da
...
\begin{Codeeffddf8c89e342188e691144000ac179}
[...]
export function mountGlossary(glossary: GlossaryObjectType){
    ...
    const acronyms = gloss_arr
        ...
        .join('\n');
\end{Codeeffddf8c89e342188e691144000ac179}
...
\begin{Codebae520c590e54eeab514702a18cf58a3}
[...]
    let str = `${header}\n\n${acronyms}\n`;
...
\end{Codebae520c590e54eeab514702a18cf58a3}
...
pelo código fonte contruído no processo de \textit{Parsing}.
...
\begin{Code8820859c44a345c8bda10c0239ed3ef3}
...
\end{Code8820859c44a345c8bda10c0239ed3ef3}
...
\begin{Codee996256328524c238dd8b058b8d76964}
yarn tex-make
\end{Codee996256328524c238dd8b058b8d76964}
