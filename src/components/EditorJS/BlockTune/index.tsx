import type { EditorBlockConstructorProps } from "@/types/EditorJs";
import type { TunesMenuConfigItem } from "@editorjs/editorjs/types/tools";

export default class BlockTune{
    private api: EditorBlockConstructorProps['api']
