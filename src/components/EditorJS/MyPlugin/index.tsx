import { EditorBlockConstructorProps } from '@/types/EditorJs';
...
export default class MyPlugin {
    ...
    private render(){
        const id = `${this.name}-${this.uuid}`
        console.log('EDITOR PLUGIN RENDER CALLED', id)
    ...
    private renderSettings(){     
        const wrapper = document.createElement('div');
        wrapper.innerHTML = `<div>Menu item</div>`;
        return wrapper;
    }
